package com.ruchir55.chatapp.views;
...
import com.ruchir55.chatapp.R;
import com.ruchir55.chatapp.databinding.ActivityUpdateProfileBinding;
...
public class UpdateProfileActivity extends AppCompatActivity {
    ...
    public void shouldShowPermissionRationaleIfNeeded() {
        ...
        if(deniedPermissions.isEmpty()) {
            ...
            Snackbar.make(updateProfileBinding.mainUpdateProfile, "Please grant necessary permissions", Snackbar.LENGTH_INDEFINITE)
                    .setAction("OK", v -> {
