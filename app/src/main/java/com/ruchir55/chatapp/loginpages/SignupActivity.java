package com.ruchir55.chatapp.loginpages;
...
import com.ruchir55.chatapp.databinding.ActivitySignupBinding;
import com.ruchir55.chatapp.models.User;
import com.ruchir55.chatapp.views.MainActivity;
...
public class SignupActivity extends AppCompatActivity {
    ...
    protected void registerActivityForMultiplePermissions() {
        ...
        permissionsresultlauncher = registerForActivityResult(new ActivityResultContracts.RequestMultiplePermissions(), result-> {
            ...
            if(allGranted) {
                ...
                if(deniedPermissionCount < 2) {
                    ...
                    builder.setMessage("You must grant the necessary permissions from the application settings to access the photos");
    ...
    public void shouldShowPermissionRationaleIfNeeded() {
        ...
        if(deniedPermissions.isEmpty()) {
            ...
            Snackbar.make(signupBinding.mainSignup, "Please grant necessary permissions", Snackbar.LENGTH_INDEFINITE)
                    .setAction("OK", v -> {
